...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.mode_optionemenu = customtkinter.CTkOptionMenu(self.sidebar_frame, values=["Info", "Edit", "Record", "Play"],
                                                                       command=self.mode_select_event)
        self.mode_optionemenu.grid(row=1, column=0, padx=20, pady=(10, 10))
    ...
    def mode_select_event(self, mode: str):
        print(mode)
